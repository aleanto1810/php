...
if (isset($_POST["txtAccion"])) {
    ...
    if ($accion == "Listar") {
        ...
        fwrite($archivo, "Codigo;Rut;Fono;Sala;Pelicula;Adultos;Niños;Total;Opcion \n");
        echo '<td>Codigo</td>';
        echo '<td>Rut</td>';
        echo '<td>Fono</td>';
        echo '<td>Sala</td>';
    ...
    if (isset($_GET["dato"])) {
        ...
        if ($resp > 0) {
            header("Location:reservaDeBoletos.php?mensaje='Elimino'");
        } else {
            header("Location:reservaDeBoletos.php?mensaje='No Elimino'");
        }
    }
}
